...
export const SocialLink: React.FC = () => {
  return (
    <StyledSocialLink>
      <ListItemsWrapper>
        <Link href="https://github.com/hhgtl" target={'_blank'} aria-label="Github link">
          <Icon iconId="githubGrey" width="30" height="30" viewBox="0 0 30 30" />
        </Link>
        <Link href="" target={'_blank'} aria-label="Twitter link">
          <Icon iconId="twitter" width="32" height="32" viewBox="0 0 34 34" />
        </Link>
        <Link href="" target={'_blank'} aria-label="LinkedIn link">
